            ...
            <div class="row">
                <div class="col-md-6">
                    <form id="form1" action="insert_cust.php" method="post" class="form" novalidate>
                        ...
                        <div class="form-group">
                            <label for="custContract">Customer Contract</label>
                            <input id="custContract" type="text" class="form-control" name="custContract" data-smk-msg="Require Customer Username" required>
                        </div>
						<div class="form-group">
                            <label for="custContract">Customer Contract</label>
                            <input id="custContract" type="text" class="form-control" name="custContract" data-smk-msg="Require Customer Username" required>
						...
						<div class="form-group">
                            ...
                            <input id="custTel" type="text" class="form-control" name="custTel" data-smk-msg="Require Telephone number" required>                        
						</div>
						<div class="form-group">
                            <label for="Fax">Fax</label>
                            <input id="Fax" type="text" class="form-control" name="Fax" data-smk-msg="Require Telephone number" required>                        
						</div>
                        <div class="form-group">
