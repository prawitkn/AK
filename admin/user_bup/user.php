...
?>
      ...
      <a href="user_add.php" class="btn btn-google">Add User</a>
    <div class="box box-primary">
        ...
        <div class="box-tools pull-right">
          ...
          <?php
				...
				if(isset($_GET['search_word']) and isset($_GET['search_word'])){
					...
					$sqlSearch = "and (u.userFullname like '%".$_GET['search_word']."%' ) ";
				}
                $sql = "
        ...
        <div class="box-body">
           ...
           <?php
				$sql = "
						SELECT `userID` as id, `userName`, `userPassword`, `userFullname`, `userGroupCode`, `userEmail`, `userTel`, `userPicture`, `statusCode` 
						FROM `user` u 
						WHERE 1 "
						.$sqlSearch." 
