  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
		...
		<div class="form-inline">
			...
			<a href="<?=$rootPage;?>_add.php?rtNo=" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Add Customer Return</a>
		</div>
        ...
        <div class="box-tools pull-right">
          ...
          <?php
				...
				switch($s_userGroupCode){
					...
					case 'warehouse' :
					case 'production' :
							$sql .= "AND hdr.fromCode=$s_userDept ";
						break;
					default :
				}
				if(isset($_GET['search_word']) and isset($_GET['search_word'])){
					$search_word=$_GET['search_word'];
					$sql .= "AND (hdr.rtNo like '%".$_GET['search_word']."%') ";
				}				
