  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
           <div class="row">
                <div class="col-md-6">
                    <form id="form1" action="product_add_ajax.php" method="post" class="form" novalidate>
                        <div class="form-group">
                            <label for="prodGroup">Product Group</label>                            
							<div class="input-group">
								<input id="prodGroup" type="text" class="form-control" name="prodGroup" data-smk-msg="Require Group" required>							
							</div>
                        </div>
						<div class="form-group">
                            <label for="prodName">Product Name</label>                            
							<div class="input-group">
								<input id="prodName" type="text" class="form-control" name="prodName" data-smk-msg="Require Name" required>							
							</div>
                        </div>
						<div class="form-group">
                            <label for="prodNameNew">Product Name (New)</label>                            
							<div class="input-group">
								<input id="prodNameNew" type="text" class="form-control" name="prodNameNew" data-smk-msg="Require Name New" required>							
							</div>
                        </div>
						<div class="form-group">
                            <label for="prodDesc">Product Description</label>                            
							<div class="input-group">
								<input id="prodDesc" type="text" class="form-control" name="prodDesc" data-smk-msg="Require Description" required>							
							</div>
                        </div>
						<div class="form-group">
                            <label for="prodPrice">Product Price</label>                            
							<div class="input-group">
								<input id="prodPrice" type="text" class="form-control" name="prodPrice" data-smk-msg="Require Price" value="0.00" required>							
							</div>
                        </div>
						<div class="form-group">
                            <label for="appId">App ID</label>                            
							<div class="input-group">
								<input id="appId" type="text" class="form-control" name="appId" data-smk-msg="Require App ID" required>							
							</div>
                        </div>
