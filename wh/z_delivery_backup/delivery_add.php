  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
		<?php	
			...
			$doNo = $hdr['doNo'];
			$soNo = $hdr['soNo'];
			//if(isset($_GET['soNo'])) $soNoGet=$_GET['soNo']; 
		?>
		...
		<div class="row col-md-12">
			<form id="form2" action="delivery_add_item_submit_ajax.php" method="post" class="form" novalidate>
				...
				<table id="tbl_items" class="table table-striped">
					...
					<td><a href="delivery_add_item_search.php?doNo=<?=$hdr['doNo'];?>&doDtlId=<?=$row['id'];?>&code=<?=$row['prodCode'];?>" class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i> Edit</a></td>
					</tr>
					<?php $row_no+=1; } ?>
				</table>
				</div>
