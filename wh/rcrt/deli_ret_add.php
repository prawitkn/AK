  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">	  
	  <h1><i class="glyphicon glyphicon-arrow-left"></i>
       Delivery Return
        <small>Delivery Return management</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?=$rootPage;?>.php"><i class="glyphicon glyphicon-list"></i>Delivery Return List</a></li>
		<li><a href="#"><i class="glyphicon glyphicon-edit"></i>Delivery Return</a></li>
    </section>
    ...
    <div class="box box-primary">
        ...
        <h3 class="box-title">Add Delivery Return No. : <?=$rtNo;?></h3>
        ...
        <div class="box-body">			
            <div class="row">
                ...
                <div class="col-md-12">   
					<div class="row">
						<div class="col-md-3">
							<label for="refNo" >Referene Delivery No.</label>
		...
		<!--row-->
			...
			FROM `deli_ret_detail` dtl	
			LEFT JOIN wh_deli_return_reason_type rrt on rrt.code=dtl.returnReasonCode 
			WHERE 1
			AND dtl.rtNo=:rtNo  
			";
			$stmt = $pdo->prepare($sql);
		...
		<div class="row col-md-12">
			...
			<form id="form2" action="delivery_add_item_submit_ajax.php" method="post" class="form" novalidate>
				...
				<a name="btn_view" href="rt_view.php?rtNo=<?=$rtNo;?>" class="btn btn-default"><i class="glyphicon glyphicon-search"></i> View</a>
				</form>
			</div>
			<!--/.row dtl-->
      ...
      <div class="modal-body">
        <div class="form-horizontal">
			<div class="form-group">	
				<label for="year_month" class="control-label col-md-2">DO NO.</label>
				<div class="col-md-4">
			...
			$.smkConfirm({text:'Are you sure to Create? ?',accept:'Yes.', cancel:'Cancel'}, function (e){if(e){
				$.post({
					...
					if (data.success){  
						...
						window.location.href = "<?=$rootPage;?>_add.php?rtNo=" + data.rtNo;
					}else{
						$.smkAlert({
							text: data.message,
							type: 'danger',
